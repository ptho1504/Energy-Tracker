package com.ptho1504.usage_service.service;
...
import com.ptho1504.kafka.event.AlertingEvent;
import com.ptho1504.usage_service.client.DeviceClient;
import com.ptho1504.usage_service.client.UserClient;
import com.ptho1504.usage_service.dto.DeviceDto;
import com.ptho1504.kafka.event.EnergyUsageEvent;
import com.ptho1504.usage_service.dto.UsageDto;
import com.ptho1504.usage_service.dto.UserDto;
import com.ptho1504.usage_service.model.Device;
import com.ptho1504.usage_service.model.DeviceEnergy;
...
//        log.info("Received energy usage event: {}", energyUsageEvent);
        ...
        this.influxDBClient.getWriteApiBlocking().writePoint(bucket, influxOrg, point);
    }
